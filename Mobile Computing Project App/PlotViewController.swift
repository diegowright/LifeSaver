...
class PlotViewController: UIViewController, JBBarChartViewDelegate, JBBarChartViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        var timer = Timer.scheduledTimer(timeInterval: 0.5, target: self, selector: #selector(PlotViewController.showChart), userInfo: nil, repeats: false)
    }
